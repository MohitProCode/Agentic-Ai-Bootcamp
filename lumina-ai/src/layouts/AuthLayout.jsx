...
// ─── Auth Layout ──────────────────────────────
// Exact match: global_utility_header from login/signup HTMLs
const AuthLayout = () => {
  return (
    <div className="text-slate-200 min-h-screen flex flex-col relative overflow-hidden" style={{ background: '#0f172a' }}>
      ...
      {/* Footer */}
      <footer id="global_utility_footer" className="w-full p-6 flex justify-between items-center text-xs z-20 relative" style={{ color: '#64748b' }}>
